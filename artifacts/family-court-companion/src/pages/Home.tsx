...
import { Plus, Search, Layers, FileText, CalendarDays, Activity } from "lucide-react";
  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[
          { label: "Evidence", value: activeCase.evidenceStats.totalEntries },
          { label: "Weak Factors", value: activeCase.evidenceStats.weakFactors },
          { label: "Missing Factors", value: activeCase.evidenceStats.missingFactors },
          { label: "Documents", value: activeCase.evidenceStats.documents },
        ].map((stat, i) => (
          <Card key={i}>
      ...
      <div>
        <div className="flex items-center justify-between mb-3">
          ...
          <Link href="/evidence/library" className="text-sm text-primary font-medium">View All</Link>
        </div>
